...
#define ToonPower        0.75    // 影の暗さ
#define OverBright       2.2    // 白飛び覚悟の明るさ補正
...
//#define USE_SPECULAR_MAP // 使う? (使わない場合、左に//)
    #define SPECULAR_MAP_PATH "chr_sonic_cloth_spc_HD.png"

// ●法線マップ(法線の方向を変えて凹凸感、重い)
#define USE_NORMAL_MAP // 使う? (使わない場合、左に//)
    #define NORMAL_MAP_PATH "chr_sonic_cloth_nrm_HD.png"
...
//#define USE_HEIGHT_MAP // 使う? (使わない場合、左に//)
    #define HEIGHT_MAP_PATH "chr_sonic_cloth_POW_HD.png"
