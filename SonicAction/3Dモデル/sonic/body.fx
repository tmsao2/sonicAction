...
//#define USE_SPECULAR_MAP // 使う? (使わない場合、左に//)
    #define SPECULAR_MAP_PATH "chr_sonic_body01_spc_HD.png"

// ●法線マップ(法線の方向を変えて凹凸感、重い)
#define USE_NORMAL_MAP // 使う? (使わない場合、左に//)
    #define NORMAL_MAP_PATH "chr_sonic_body01_nrm_HD.png"
...
//#define USE_HEIGHT_MAP // 使う? (使わない場合、左に//)
    #define HEIGHT_MAP_PATH "chr_sonic_body01_POW_HD.png"
